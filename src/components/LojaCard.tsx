...
const LojaCard: React.FC<LojaCardProps> = ({loja}) => {
    ...
    return (
            <div className="w-72 md:w-80 xl:w-full relative rounded overflow-hidden shadow-lg bg-white transform transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl cursor-pointer">
